package org.firstinspires.ftc.teamcode.imported;

import static org.firstinspires.ftc.teamcode.imported.PedroTuningOpMode.*;
...
public final class PedroTuningOpMode extends SelectableOpMode {
    ...
    public void onSelect() {
        if (follower == null) {
            follower = Constants.FOLLOWER_FACTORY.apply(hardwareMap);
